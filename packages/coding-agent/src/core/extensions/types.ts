...
export function isPowerShellToolResult(
  e: ToolResultEvent,
): e is PowerShellToolResultEvent {
...
export interface ExtensionAPI {
  ...
  on(
    ...
    handler: ExtensionHandler<SessionInfoChangedEvent>,
  ): void;
  on(
  ...
  on(
    ...
    handler: ExtensionHandler<UIPromptStartEvent>,
  ): void;
...
export interface ExtensionRuntimeState {
  /** Shared event bus used by extensions and the host UI. */
  events: EventBus;
...
export interface ExtensionRuntime
  extends ExtensionRuntimeState, ExtensionActions {}
